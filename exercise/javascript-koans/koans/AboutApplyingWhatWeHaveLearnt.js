...
describe("About Applying What We Have Learnt", function () {
    ...
    it("should add all the natural numbers below 1000 that are multiples of 3 or 5 (functional)", function () {
        ...
        // var number = (start, stop, step) => Array.from({length: stop - start / step + 1}, (_, i) => start + i * step);

        // var numbers = Array.from({length: 999}, (it, i) => i + 1);

        // console.log(numbers);
        var sum = _.range(1, 1000).reduce((accumulator, currentValue) => {
    ...
    it("should count the ingredient occurrence (functional)", function () {
        ...
        const count = _(products).chain()
            .map(function(products) {return products.ingredients})
            .flatten()
            .reduce(function (ingredient,ingredientCount){
